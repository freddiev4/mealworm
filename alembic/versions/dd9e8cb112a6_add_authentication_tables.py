...
def upgrade() -> None:
    ...
    op.create_table('generated_meal_plans',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_generated_meal_plans_user_id'), 'generated_meal_plans', ['user_id'], unique=False)
    op.create_index(op.f('ix_generated_meal_plans_week_starting'), 'generated_meal_plans', ['week_starting'], unique=False)
...
def downgrade() -> None:
    ...
    op.create_index('idx_meal_plans_content_id', 'meal_plans', ['content_id'], unique=False)
    op.create_index('idx_meal_plans_content_hash', 'meal_plans', ['content_hash'], unique=False)
